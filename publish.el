...
(setq user-full-name "Weaver Marquez")
(setq user-mail-address "weavermarquez0@example.com")

(defvar dw/site-url (if (string-equal (getenv "CI") "true")
                        "https://weavermarquez.github.io"
                      "http://localhost:8080")
                 ...
                 (div (@ (class "container"))
                      (div (@ (class "row"))
                           (div (@ (class "column"))
                                ...
                                (p "© 2021-2023 System Crafters LLC, and also Weaver Ripped this off"))
                           (div (@ (class "column align-right"))
                                (p (a (@ (href "https://github.com/weavermarquez/weavermarquez.github.io"))
   ...
   (sxml-to-xml
    `(html (@ (lang "en"))
           (head
            ...
            (script (@ (defer "defer")
                       (data-domain "weavermarquez.github.io")
